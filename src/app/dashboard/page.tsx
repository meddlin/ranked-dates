  ...
  return (
    <div className="p-6 max-w-7xl mx-auto" data-oid="l.b8psm">
      ...
      <div
        ...
        data-oid="u4-ia-5"
      >
        <div className="text-center" data-oid="-y0ttqe">
          <h2 className="text-xl font-semibold mb-4" data-oid="s8j.msj">
            Import Google Maps Data
          </h2>
          <p className="text-gray-600 mb-4" data-oid="f2h.1gm">
          ...
          >
            ...
            <div className="text-center" data-oid="bn1o_h5">
              <svg
              ...
              {isUploading ? (
                ...
                <div data-oid="t7g7gnw">
                  ...
                  <p className="text-sm text-gray-500" data-oid="_edbrf1">
      ...
      {data.length > 0 && (
        ...
        >
          <div
            ...
            data-oid="25n1ew7"
          >
            <h2 className="text-xl font-semibold" data-oid="5q28moz">
              Your Saved Places ({data.length})
            </h2>
          </div>

          <div className="overflow-x-auto" data-oid=".xi4dax">
            <table
              className="min-w-full divide-y divide-gray-200"
              data-oid="f.n5r89"
            >
              <thead className="bg-gray-50" data-oid="ctdrxv-">
      ...
      {data.length === 0 && !isUploading && (
        <div className="text-center py-12" data-oid="j36x5gl">
          <svg
            className="mx-auto h-12 w-12 text-gray-400 mb-4"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <p className="text-gray-500" data-oid="wa61i3k">
      ...
      >
        ...
        <div className="text-sm text-gray-500" data-oid="5sncs1m">
