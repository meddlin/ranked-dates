...
export default function Home() {
  ...
  return (
    ...
    //   </main>
    // </div>
    <main data-oid="ji59r8m">
      <section className="py-20" data-oid="laekv4s">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          data-oid="1q446k5"
        >
          <div className="lg:grid lg:grid-cols-12 lg:gap-8" data-oid="wyi0:yk">
            <div
            ...
            >
              ...
              <div
                ...
                data-oid="-8vmnnd"
              >
                <Link href="/sign-up" data-oid="wu7c-n5">
                  <Button
                  ...
                  >
                    Sign Up
                    <ArrowRight className="ml-2 h-5 w-5" data-oid="bun.8ry" />
                  </Button>
                </Link>
              </div>
            </div>
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="a.htscl"
                    >
                      <h1 className="text-xl font-bold" data-oid="h8xa--e">
                        Ranked Dates
                      </h1>
                      <div
                    ...
                    <p className="text-orange-100 text-sm" data-oid="j18flt3">
                      Your places. Your way.
                    </p>
                  </div>

                  <div className="p-4 space-y-3" data-oid="-ed5b8j">
                    <div
      ...
      <section className="py-16 bg-white w-full" data-oid="wri9e3h">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          data-oid="2voihlk"
        >
          <div className="lg:grid lg:grid-cols-3 lg:gap-8" data-oid="p-wy4q9">
            <div data-oid="4108vfl">
              <div
                className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white"
                data-oid="wt2hg10"
              >
                <svg viewBox="0 0 24 24" className="h-6 w-6" data-oid="9oub.to">
                  <path
                    fill="currentColor"
              ...
              <div className="mt-5" data-oid="qxxo10e">
                <h2
                ...
                <p className="mt-2 text-base text-gray-500" data-oid="muqx.1d">
            ...
            <div className="mt-10 lg:mt-0" data-oid="rdg52s6">
              <div
                className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white"
                data-oid="6pr41mx"
              >
                <Database className="h-6 w-6" data-oid="hmvny0e" />
              </div>
              <div className="mt-5" data-oid="c9e.ca4">
                <h2
                  className="text-lg font-medium text-gray-900"
                  data-oid="d-ynigx"
                >
                ...
                <p className="mt-2 text-base text-gray-500" data-oid="4z3dcs7">
            ...
            <div className="mt-10 lg:mt-0" data-oid="ex7xhcb">
              <div
                className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white"
                data-oid="qg8s94b"
              >
                <CreditCard className="h-6 w-6" data-oid="88k37e5" />
              </div>
              <div className="mt-5" data-oid="64ujrgj">
                <h2
                  className="text-lg font-medium text-gray-900"
                  data-oid="9szcpha"
                >
                ...
                <p className="mt-2 text-base text-gray-500" data-oid="59-u_gv">
      ...
      <section className="py-16 bg-gray-50" data-oid="2t5c_ka">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          data-oid="o5vuwwg"
        >
          ...
          >
            ...
            <div
              ...
              data-oid="mlockcc"
            >
              <Link href="/sign-in" data-oid="01r2epw">
                <Button
                ...
                >
                  Sign In
                  <ArrowRight className="ml-3 h-6 w-6" data-oid="ev_ujmt" />
                </Button>
              </Link>
            </div>
          </div>
