              ...
              <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px]">
                ...
                <div className="rounded-[2rem] overflow-hidden w-[272px] h-[572px] bg-white dark:bg-gray-800">
                  ...
                  <div className="p-4 space-y-3">
                    <div className="bg-gray-50 rounded-lg p-3 border-l-4 border-orange-500">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-gray-600 text-xs">Downtown • $$</p>
                        </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 border-l-4 border-orange-400">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-gray-600 text-xs">Midtown • $</p>
                        </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 border-l-4 border-orange-300">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="font-semibold text-gray-900 text-sm">
                            Park Trail
                    ...
                    <div className="bg-gray-50 rounded-lg p-3 border-l-4 border-gray-300">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-gray-600 text-xs">East End • $</p>
                        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <div className="mt-5">
                <h2 className="text-lg font-medium text-gray-900">Ranked</h2>
                <p className="mt-2 text-base text-gray-500">
