...
export default function Home() {
  ...
  return (
    ...
    // </div>
    <main data-oid="efrpt::">
      <section className="py-20" data-oid="2qabx1i">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          data-oid="ll01bjv"
        >
          <div className="lg:grid lg:grid-cols-12 lg:gap-8" data-oid="ipfwdb8">
            <div
            ...
            >
              ...
              >
                Ranked Dates
                <span className="block text-orange-500" data-oid="y28_u_r">
              ...
              <div
                ...
                data-oid="ebzy681"
              >
                <Link href="/sign-up" data-oid="i36i:bv">
                  <Button
                  ...
                  >
                    Sign Up
                    <ArrowRight className="ml-2 h-5 w-5" data-oid="6vnhn4a" />
                  </Button>
                </Link>
              </div>
            </div>
            ...
            >
              {/* <Terminal /> */}
              <span data-oid="wl4_ki6">phone mockup here</span>
            </div>
          </div>
        </div>
      </section>

      <section className="py-16 bg-white w-full" data-oid="dhy5wdv">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          data-oid="ms1zavn"
        >
          <div className="lg:grid lg:grid-cols-3 lg:gap-8" data-oid="e:fe4h4">
            <div data-oid="iyyaojx">
              <div
                className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white"
                data-oid="_b018ut"
              >
                <svg viewBox="0 0 24 24" className="h-6 w-6" data-oid="m2yyl6j">
                  <path
                    fill="currentColor"
              ...
              <div className="mt-5" data-oid="h1cqgtx">
                <h2
                ...
                <p className="mt-2 text-base text-gray-500" data-oid="gsf26lk">
            ...
            <div className="mt-10 lg:mt-0" data-oid="3htzb9j">
              <div
                className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white"
                data-oid="7ct:7xi"
              >
                <Database className="h-6 w-6" data-oid="kt7kaa4" />
              </div>
              <div className="mt-5" data-oid="r:a5uk.">
                <h2
                  className="text-lg font-medium text-gray-900"
                  data-oid="14knx62"
                >
                ...
                <p className="mt-2 text-base text-gray-500" data-oid="eckuc5j">
            ...
            <div className="mt-10 lg:mt-0" data-oid="fap827o">
              <div
                className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white"
                data-oid=":pexkl8"
              >
                <CreditCard className="h-6 w-6" data-oid=":uxk_pc" />
              </div>
              <div className="mt-5" data-oid="kaq5yri">
                <h2
                  className="text-lg font-medium text-gray-900"
                  data-oid="cnba83s"
                >
                ...
                <p className="mt-2 text-base text-gray-500" data-oid="_cctb7n">
      ...
      <section className="py-16 bg-gray-50" data-oid="e3t2r0l">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          data-oid="o88e55k"
        >
          ...
          >
            ...
            <div
              ...
              data-oid="dch6wfr"
            >
              <Link href="/sign-in" data-oid="0pmexgi">
                <Button
                ...
                >
                  Sign In
                  <ArrowRight className="ml-3 h-6 w-6" data-oid="yk5-gms" />
                </Button>
              </Link>
            </div>
          </div>
