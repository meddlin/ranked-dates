...
export default function Home() {
  ...
  return (
    ...
    //   </main>
    // </div>
    <main data-oid="0yzu-ik">
      <section className="py-20" data-oid="bk:hkxu">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          data-oid="5t0x0ri"
        >
          <div className="lg:grid lg:grid-cols-12 lg:gap-8" data-oid="whkcufp">
            <div
            ...
            >
              ...
              <div
                ...
                data-oid="if:f2yr"
              >
                <Link href="/sign-up" data-oid="yce371b">
                  <Button
                  ...
                  >
                    Sign Up
                    <ArrowRight className="ml-2 h-5 w-5" data-oid="2p4krc_" />
                  </Button>
                </Link>
              </div>
            </div>
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-oid="-xpewrr"
                    >
                      <h1 className="text-xl font-bold" data-oid="cx6s9_q">
                        Ranked Dates
                      </h1>
                      <div
                    ...
                    <p className="text-orange-100 text-sm" data-oid="kpdmga7">
                      Your places. Your way.
                    </p>
                  </div>

                  <div className="p-4 space-y-3" data-oid="decot.0">
                    <div
      ...
      <section className="py-16 bg-white w-full" data-oid="q:oaxr5">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          data-oid=":d9fynw"
        >
          <div className="lg:grid lg:grid-cols-3 lg:gap-8" data-oid="qg9g:tj">
            <div data-oid="f4f3:u6">
              <div
                className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white"
                data-oid="_9p0u3-"
              >
                <svg viewBox="0 0 24 24" className="h-6 w-6" data-oid="-0c2enz">
                  <path
                    fill="currentColor"
              ...
              <div className="mt-5" data-oid="3nstgc2">
                <h2
                ...
                <p className="mt-2 text-base text-gray-500" data-oid="zpe4x:q">
            ...
            <div className="mt-10 lg:mt-0" data-oid="fsaw5.f">
              <div
                className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white"
                data-oid="ey1btja"
              >
                <Database className="h-6 w-6" data-oid="aeypbk3" />
              </div>
              <div className="mt-5" data-oid="zv0b0n6">
                <h2
                  className="text-lg font-medium text-gray-900"
                  data-oid="n:-1lv7"
                >
                ...
                <p className="mt-2 text-base text-gray-500" data-oid="l-j_kas">
            ...
            <div className="mt-10 lg:mt-0" data-oid="5dk9v5:">
              <div
                className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white"
                data-oid="ge8ih1h"
              >
                <CreditCard className="h-6 w-6" data-oid="oqccsa_" />
              </div>
              <div className="mt-5" data-oid="x3n3auv">
                <h2
                  className="text-lg font-medium text-gray-900"
                  data-oid="s10h8ud"
                >
                ...
                <p className="mt-2 text-base text-gray-500" data-oid=".2q0fkj">
      ...
      <section className="py-16 bg-gray-50" data-oid="s9kda:1">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          data-oid="vcq_w9w"
        >
          ...
          >
            ...
            <div
              ...
              data-oid="6dfsja5"
            >
              <Link href="/sign-in" data-oid="crnt5:n">
                <Button
                ...
                >
                  Sign In
                  <ArrowRight className="ml-3 h-6 w-6" data-oid="uqkn8mg" />
                </Button>
              </Link>
            </div>
          </div>
