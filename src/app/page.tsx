...
export default function Home() {
  ...
  return (
    ...
    //   </main>
    // </div>
    <main data-oid="232p26j">
      <section className="py-20" data-oid="jgl-qj7">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          data-oid="76fa4yx"
        >
          <div className="lg:grid lg:grid-cols-12 lg:gap-8" data-oid="8jrpvpx">
            <div
            ...
            >
              ...
              <div
                ...
                data-oid="2zoba:1"
              >
                <Link href="/sign-up" data-oid="93mnq6:">
                  <Button
                  ...
                  >
                    Sign Up
                    <ArrowRight className="ml-2 h-5 w-5" data-oid="5-z:jve" />
                  </Button>
                </Link>
              </div>
            </div>
      ...
      <section className="py-16 bg-white w-full" data-oid="-ni23lm">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          data-oid="2ojbgi3"
        >
          <div className="lg:grid lg:grid-cols-3 lg:gap-8" data-oid="_7o8e7u">
            <div data-oid="wqul4bb">
              <div
                className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white"
                data-oid=".jxe4l0"
              >
                <svg viewBox="0 0 24 24" className="h-6 w-6" data-oid="8tb49-q">
                  <path
                    fill="currentColor"
              ...
              <div className="mt-5" data-oid=".-iq6zl">
                <h2
                ...
                <p className="mt-2 text-base text-gray-500" data-oid="3c.4j_g">
            ...
            <div className="mt-10 lg:mt-0" data-oid="st4q3cq">
              <div
                className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white"
                data-oid="0ot.mwh"
              >
                <Database className="h-6 w-6" data-oid="ia63yl-" />
              </div>
              <div className="mt-5" data-oid="tvdljyg">
                <h2
                  className="text-lg font-medium text-gray-900"
                  data-oid=".gd05wr"
                >
                ...
                <p className="mt-2 text-base text-gray-500" data-oid="93pro1e">
            ...
            <div className="mt-10 lg:mt-0" data-oid="v5vob:k">
              <div
                className="flex items-center justify-center h-12 w-12 rounded-md bg-orange-500 text-white"
                data-oid="492hbg3"
              >
                <CreditCard className="h-6 w-6" data-oid="3astui4" />
              </div>
              <div className="mt-5" data-oid="zt28gs:">
                <h2
                  className="text-lg font-medium text-gray-900"
                  data-oid="dep1exx"
                >
                ...
                <p className="mt-2 text-base text-gray-500" data-oid="0rjmgma">
      ...
      <section className="py-16 bg-gray-50" data-oid="hbizx0x">
        <div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          data-oid="qe_zppc"
        >
          ...
          >
            ...
            <div
              ...
              data-oid="3wlf:.x"
            >
              <Link href="/sign-in" data-oid="g5qsik-">
                <Button
                ...
                >
                  Sign In
                  <ArrowRight className="ml-3 h-6 w-6" data-oid="gvpwnea" />
                </Button>
              </Link>
            </div>
          </div>
